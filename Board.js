...
cardClockwise(index) {
  if (this.cards[index] !== null) this.cards[index].clockwise();
}

cardAnticlockwise(index) {
  if (this.cards[index] !== null) this.cards[index].anticlockwise();
}

slotClockwise(index) {
  if (this.slots[index] !== null) this.slots[index].clockwise();
}

slotAnticlockwise(index) {
  if (this.slots[index] !== null) this.slots[index].anticlockwise();
}
